...
- Run date: `2026-08-25T19:09:20.702052+00:00`
- Total cases: 3
- Routed roles: patient=3
- Response time: n/a
...
- Moderation blocks: 1/3 (33.3%)
  - By category: `toxicity`=1
- Insufficient-evidence refusals: 1/3 (33.3%)
...
|---|---|---|---|---|---|
| `theme:test` | 1/3 | 100.0% | 0.800 | 0.0% | 0.0% |
...
- `case-mod` -- low confidence or low monitored RAG metric
- `case-limited` -- low confidence or low monitored RAG metric
- `case-normal` -- low confidence or low monitored RAG metric
